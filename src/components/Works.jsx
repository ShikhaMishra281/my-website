    ...
    <>
      ...
      <div className="w-full flex">
        <p className="mt-3 text-secondary text-[17px] max-w-3xl leading-[30px]">
          The following projects showcase my expertise in Angular, TypeScript, and full-stack development. Each project demonstrates my ability to develop responsive, efficient applications with modern frameworks and technologies. My portfolio highlights experience in both frontend excellence and backend integration, with a focus on performance optimization and security best practices.
        </p>
      </div>
